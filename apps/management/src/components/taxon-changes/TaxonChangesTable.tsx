...
type TaxonChangesTableProps = {
  data: TaxonChangeData[];
};

export const TaxonChangesTable = ({ data }: TaxonChangesTableProps) => {
  ...
  if (sortedRecords.length === 0) {
    return <p>There are no taxon changes.</p>;
  }
      ...
      <thead>
        <tr>
          ...
          <Th
            ...
            onSort={onSort}
          />
          <Th col="newSpeciesName" label="New Name" currentSortCol={sortCol} currentSortDir={sortDir} onSort={onSort} />
          <Th
            col="taxonChangeType"
            label="Change Type"
            currentSortCol={sortCol}
